...
int _messageEstimateSize(
  ...
  {
    final value = object.recognizedText;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _messageSerialize(
  ...
  writer.writeString(offsets[5], object.timestamp);
}
...
Message _messageDeserialize(
  ...
  object.recognizedText = reader.readStringOrNull(offsets[4]);
  object.timestamp = reader.readString(offsets[5]);
  return object;
}
...
extension MessageQueryWhereSort on QueryBuilder<Message, Message, QWhere> {
  ...
  QueryBuilder<Message, Message, QAfterWhere> anyChatId() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryWhere on QueryBuilder<Message, Message, QWhereClause> {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> chatIdEqualTo(int chatId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> chatIdGreaterThan(
    int chatId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> chatIdLessThan(
    int chatId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> chatIdBetween(
    int lowerChatId,
    int upperChatId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MessageQueryFilter
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> recognizedTextIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> recognizedTextEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> recognizedTextLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> recognizedTextBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> recognizedTextEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> recognizedTextContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> recognizedTextMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension MessageQuerySortBy on QueryBuilder<Message, Message, QSortBy> {
  ...
  QueryBuilder<Message, Message, QAfterSortBy> sortByRecognizedText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recognizedText', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByRecognizedTextDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQuerySortThenBy
  ...
  QueryBuilder<Message, Message, QAfterSortBy> thenByRecognizedText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recognizedText', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByRecognizedTextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recognizedText', Sort.desc);
    });
  }
...
extension MessageQueryWhereDistinct
  ...
  QueryBuilder<Message, Message, QDistinct> distinctByRecognizedText(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryProperty
  ...
  QueryBuilder<Message, String?, QQueryOperations> recognizedTextProperty() {
    return QueryBuilder.apply(this, (query) {
